...
public class Exercicio2While {
	...
	public static void main(String[] args) {
		...
		do {
			escolaridade = JOptionPane.showInputDialog("Digite o nível de escolaridade").toLowerCase();
		...
		System.out.println("VocÊ digitou uma escolaridade inválida. Finalizando a contagem...");
