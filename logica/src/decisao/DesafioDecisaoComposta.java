...
public class DesafioDecisaoComposta {
	...
	public static void main(String[] args) {
		...
		float valor_unitario = Float.parseFloat(JOptionPane.showInputDialog("Valor unitário"));
